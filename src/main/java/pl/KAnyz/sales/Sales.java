package pl.KAnyz.sales;

import pl.KAnyz.sales.cart.Cart;
import pl.KAnyz.sales.cart.CartItem;
import pl.KAnyz.sales.cart.CartStorage;
import pl.KAnyz.sales.offerting.Offer;
import pl.KAnyz.sales.offerting.OfferCalculator;
import pl.KAnyz.sales.payment.DummyPaymentGateway;
import pl.KAnyz.sales.payment.PaymentDetails;
import pl.KAnyz.sales.payment.PaymentGateway;
import pl.KAnyz.sales.product.ListProductDetailsProvider;
import pl.KAnyz.sales.product.ProductDetails;
import pl.KAnyz.sales.product.ProductDetailsProvider;
import pl.KAnyz.sales.product.ProductNotAvailableException;
import pl.KAnyz.sales.reservation.InMemoryReservationStorage;
import pl.KAnyz.sales.reservation.Reservation;
